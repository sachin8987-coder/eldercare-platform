...
function StarRating({ rating }) {
  return <span style={{ color: "#f59e0b", fontSize: "0.85rem" }}>{"★".repeat(Math.floor(rating))}{"☆".repeat(5 - Math.floor(rating))} <span style={{ color: "#888", fontWeight: 500 }}>{rating}</span></span>;
}
